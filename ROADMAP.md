...
| 12 | Lancement par conteneur vivant — `make up` / `make exec` / `make evaluate <nom>` / `make down`, Compose `sleep infinity`, README refait | 00 § 6 (amendée 2026-08-29) | 9, 11 | `compose.yaml`, `Makefile`, `README.md` | #31 | à faire |
