...
| 19 | READMEs d'architecture — panneaux une page : `.claude/README.md` (harnais), `src/README.md` (hexagonal), pointeurs vers specs, zéro duplication (source unique `AGENTS.md`) | 08 § 12 · 00 § 7 | 18 | `.claude/README.md`, `src/README.md` | #56 | à faire |
